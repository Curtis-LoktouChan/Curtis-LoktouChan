...
interface IUserModel {
  ...
  effects: {
    ...
    setTestStateEffect: Effect
    setFinalScoreEffect: Effect
  ...
  reducers: {
    ...
    setTestState: Reducer<IAdaptiveLearningModelState>
    setFinalScore: Reducer<IAdaptiveLearningModelState>
    setStage: Reducer<IAdaptiveLearningModelState>
  }
}
...
const adaptiveLearningModel: IUserModel = {
  ...
  effects: {
    ...
    *setTestStateEffect({ payload }, { put }) {
      yield put({
        type: 'setTestState',
        payload
      })
    },
    *setFinalScoreEffect({ payload }, { put }) {
      yield put({
        type: 'setFinalScore',
        payload
      })
    },
    *setStageEffect({ payload }, { put }) {
      yield put({
        type: 'setStage',
        payload
      })
  ...
  reducers: {
    ...
    setTestState(state, { payload }) {
      return {
        ...state!,
        hasMock: payload.hasMock
      }
    },
    setFinalScore(state, { payload }) {
      return {
        ...state!,
