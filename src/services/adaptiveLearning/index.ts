...
export default {
  ...
  // 模拟测试
  mockExam: apiHandle<null, IUnitTestResponse>({
    method: 'GET',
    url: `${PREFIX_URL_V1}selfAdapt/mockExam`
  }),
  // 期末测试
  finalExam: apiHandle<null, IUnitTestResponse>({
    method: 'GET',
    url: `${PREFIX_URL_V1}selfAdapt/finalExam`
  }),
  // 期末测试提交
  submitFinalExam: apiHandle<ISubmitExam, ISubmitFinalExam>({
    method: 'POST',
    url: `${PREFIX_URL_V1}selfAdapt/finalExamSubmit`
  })
}
